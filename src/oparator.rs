...
fn main() {
    ...
    let kcle_longtitude_degrees: f64 = -81.851111;

    let kslc_latitude_degrees: f64 = 40.7861;
    let kslc_longtitude_degrees: f64 = -111.9822;
    ...
    let delta_longtitude = (kcle_longtitude_degrees - kslc_longtitude_degrees).to_radians();
